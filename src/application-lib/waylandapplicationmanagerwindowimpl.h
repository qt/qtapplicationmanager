...
#include <QtAppManShared/applicationmanagerwindowimpl.h>
...
class Q_APPMANAPPLICATION_EXPORT WaylandApplicationManagerWindowImpl : public ApplicationManagerWindowImpl
{
public:
...
class Q_APPMANAPPLICATION_EXPORT WaylandApplicationManagerWindowAttachedImpl : public ApplicationManagerWindowAttachedImpl
{
public:
