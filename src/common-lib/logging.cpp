...
\row
    \li \c am.runtime.qml
    \li \c QMRT
    \li QML messages from the application manager's runtime
\row
    \li \c am.notify
    \li \c NTFY
...
QDLT_LOGGING_CATEGORY(LogIntentServer, "am.intent.server", "INTS", "Intents sub-system messages (server side)")
QDLT_LOGGING_CATEGORY(LogIntentClient, "am.intent.client", "INTC", "Intents sub-system messages (client side)")
QDLT_LOGGING_CATEGORY(LogIntentParams, "am.intent.params", "INTP", "Intents sub-system messages (request parameters)")
