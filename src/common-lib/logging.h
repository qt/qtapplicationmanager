...
QT_DECLARE_EXPORTED_QT_LOGGING_CATEGORY(LogWayland, QTAM_DUMMY_EXPORT)
...
QT_DECLARE_EXPORTED_QT_LOGGING_CATEGORY(LogWatchdog, QTAM_DUMMY_EXPORT)
QT_DECLARE_EXPORTED_QT_LOGGING_CATEGORY(LogStartupTimer, QTAM_DUMMY_EXPORT)
QT_DECLARE_EXPORTED_QT_LOGGING_CATEGORY(LogCrypto, QTAM_DUMMY_EXPORT)

#if QT_VERSION < QT_VERSION_CHECK(6, 9, 0)
#  undef QT_DECLARE_EXPORTED_QT_LOGGING_CATEGORY
#endif
