...
QT_DECLARE_EXPORTED_QT_LOGGING_CATEGORY(LogIntentServer, Q_APPMANCOMMON_EXPORT)
QT_DECLARE_EXPORTED_QT_LOGGING_CATEGORY(LogIntentClient, Q_APPMANCOMMON_EXPORT)
QT_DECLARE_EXPORTED_QT_LOGGING_CATEGORY(LogIntentParams, Q_APPMANCOMMON_EXPORT)
