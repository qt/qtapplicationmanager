...
class Q_APPMANSHARED_EXPORT ApplicationManagerWindow : public QObject, public QQmlParserStatus
{
    Q_OBJECT
...
class Q_APPMANSHARED_EXPORT ApplicationManagerWindowAttached : public QObject
{
    Q_OBJECT
