...
class Q_APPMANSHARED_EXPORT AbstractIntentHandler : public QObject, public QQmlParserStatus
{
    Q_OBJECT
...
class Q_APPMANSHARED_EXPORT IntentHandler : public AbstractIntentHandler
{
    Q_OBJECT
