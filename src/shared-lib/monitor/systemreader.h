...
class Q_APPMANSHARED_EXPORT CpuReader
{
public:
    CpuReader();
    qreal readLoadValue();
...
class Q_APPMANSHARED_EXPORT GpuVendor {
public:
    enum Vendor {
...
class Q_APPMANSHARED_EXPORT GpuReader
{
public:
    GpuReader();
...
class Q_APPMANSHARED_EXPORT MemoryReader
{
public:
    MemoryReader();
#if defined(Q_OS_LINUX)
...
class Q_APPMANSHARED_EXPORT IoReader
{
public:
...
class Q_APPMANSHARED_EXPORT MemoryThreshold : public QObject
{
    Q_OBJECT
...
class Q_APPMANSHARED_EXPORT MemoryWatcher : public QObject
{
    Q_OBJECT
public:
