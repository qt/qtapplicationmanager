...
function(qt_am_internal_find_host_packager)
    ...
    if(NOT QT_HOST_PATH)
        find_package(Qt6 COMPONENTS AppManSystemUIPrivateTools)
        return()
    endif()
    ...
    find_package(Qt6AppManSystemUIPrivateTools ${PROJECT_VERSION} CONFIG
        PATHS
...
function(qt6_am_create_installable_package target)
    ...
    if (ARG_FAKEROOT)
        ...
        if (FAKEROOT_EXECUTABLE)
            message(STATUS "Using fakeroot executable: ${FAKEROOT_EXECUTABLE}")
            set(RUN_WITH_FAKEROOT "${FAKEROOT_EXECUTABLE}")
        elseif (QT_HOST_PATH)
