...
#include <QtCore/QUrl>
#include <QtAppManPackage/applicationinfo.h>
...
class Q_APPMANSYSTEMUI_EXPORT ApplicationRequests
{
public:
...
Q_APPMANSYSTEMUI_EXPORT QDebug operator<<(QDebug debug, const Application *app);
