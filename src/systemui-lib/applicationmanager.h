...
class Q_APPMANSYSTEMUI_EXPORT ApplicationManagerInternalSignals : public QObject
{
    Q_OBJECT
Q_SIGNALS:
...
class Q_APPMANSYSTEMUI_EXPORT ApplicationManager : public QAbstractListModel
{
    Q_OBJECT
