...
class Q_APPMANSYSTEMUI_EXPORT AbstractContainerManager : public QObject
{
    Q_OBJECT
public:
...
class Q_APPMANSYSTEMUI_EXPORT AbstractContainerProcess : public QObject
{
    Q_OBJECT
...
class Q_APPMANSYSTEMUI_EXPORT AbstractContainer : public QObject
{
    Q_OBJECT
