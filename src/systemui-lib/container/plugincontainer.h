...
class Q_APPMANSYSTEMUI_EXPORT PluginContainerHelperFunctions final : public ContainerHelperFunctions
{
public:
...
class Q_APPMANSYSTEMUI_EXPORT PluginContainerManager : public AbstractContainerManager
{
    Q_OBJECT
public:
...
class Q_APPMANSYSTEMUI_EXPORT PluginContainerProcess : public AbstractContainerProcess
{
    Q_OBJECT
...
class Q_APPMANSYSTEMUI_EXPORT PluginContainer : public AbstractContainer
{
    Q_OBJECT
