...
Q_APPMANSYSTEMUI_EXPORT bool parseSpecification(const QString &debugWrapperSpecification,
                                               QStringList &resultingCommand,
                                               QMap<QString, QString> &resultingEnvironment);

Q_APPMANSYSTEMUI_EXPORT QStringList substituteCommand(const QStringList &debugWrapperCommand,
