...
#endif
#include <QtAppManSystemUI/intentserversysteminterface.h>
#include <QtAppManSystemUI/intent.h>
#include <QtAppManShared/intentclientsysteminterface.h>
#include <QtAppManShared/intenthandler.h>
#include <QtAppManPackage/intentinfo.h>
...
Q_APPMANSYSTEMUI_EXPORT IntentServer *createIntentServerAndClientInstance(PackageManager *packageManager, int disambiguationTimeout,
                                                                         int startApplicationTimeout, int replyFromApplicationTimeout,
                                                                         int replyFromSystemTimeout);
}

// the server side
class Q_APPMANSYSTEMUI_EXPORT IntentServerAMImplementation : public IntentServerSystemInterface
{
    Q_OBJECT
...
class Q_APPMANSYSTEMUI_EXPORT IntentClientAMImplementation : public IntentClientSystemInterface
{
    Q_OBJECT
...
class Q_APPMANSYSTEMUI_EXPORT IntentServerIpcConnection : public QObject
{
    Q_OBJECT
...
class Q_APPMANSYSTEMUI_EXPORT IntentServerInProcessIpcConnection : public IntentServerIpcConnection
{
    Q_OBJECT
...
class Q_APPMANSYSTEMUI_EXPORT IntentServerDBusIpcConnection : public IntentServerIpcConnection, public QDBusContext
{
    Q_OBJECT
...
class Q_APPMANSYSTEMUI_EXPORT IntentServerHandler : public AbstractIntentHandler
{
    Q_OBJECT
