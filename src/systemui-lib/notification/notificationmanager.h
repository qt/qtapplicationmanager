...
class Q_APPMANSYSTEMUI_EXPORT NotificationManagerInternalSignals : public QObject
{
    Q_OBJECT
Q_SIGNALS:
...
class Q_APPMANSYSTEMUI_EXPORT NotificationManager : public QAbstractListModel
{
    Q_OBJECT
