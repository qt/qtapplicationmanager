...
class Q_APPMANSYSTEMUI_EXPORT WindowSurface : public QWaylandQuickSurface
{
    Q_OBJECT
public:
...
class Q_APPMANSYSTEMUI_EXPORT WaylandCompositor : public QWaylandQuickCompositor // clazy:exclude=missing-qobject-macro
{
    Q_OBJECT
public:
