    ...
    function test_intents_data() {
        return [
                    ...
                    {tag: "2-1", intentId: "only2", appId: "intents1", succeeding: false,
                        ...
                        ignoreWarning: '00000000-0000-0000-0000-000000000000 [only2] {:sysui: -> intents1} is an unknown intent' },
                    ...
                    {tag: "match-2", intentId: "match", appId: "intents1", succeeding: false,
                        ...
                        errorMessage: "No matching intent handler registered.",
                        ignoreWarning: '00000000-0000-0000-0000-000000000000 [match] {:sysui: -> intents1} is an unknown intent' },
                    ...
                    {tag: "unknown-1", intentId: "unknown", appId: "intents1", succeeding: false,
                        errorMessage: "No matching intent handler registered.",
                        ignoreWarning: '00000000-0000-0000-0000-000000000000 [unknown] {:sysui: -> intents1} is an unknown intent' },
                    {tag: "unknown-2", intentId: "unknown", appId: "", succeeding: false,
                        errorMessage: "No matching intent handler registered.",
                        ignoreWarning: '00000000-0000-0000-0000-000000000000 [unknown] {:sysui: -> ?} is an unknown intent' },
