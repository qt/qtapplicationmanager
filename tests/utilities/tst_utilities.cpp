...
void tst_Utilities::validApplicationId_data()
{
...
void tst_Utilities::validApplicationId()
{
    ...
    QString errorString;
    bool result = isValidApplicationId(appId, isAlias, &errorString);
...
void tst_Utilities::validDnsName()
{
    ...
    QString errorString;
    bool result = isValidDnsName(dnsName, minParts, &errorString);
